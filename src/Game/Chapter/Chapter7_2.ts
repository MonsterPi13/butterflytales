class Chapter7_2 extends egret.DisplayObjectContainer {
  ...
  private initView () {
    ...
    this.cha7_2_01 = new Comic2(cha7_01_options);
    this.mainContent.addChild(this.cha7_2_01);
  }
  ...
  private onClickView () {
    ...
    switch (this.picIndex) {
      case 1: 
        GameUtil.loadNextChapter(this, "LOAD_CHAPTER_7_3");
        break;
    }
    this.picIndex ++;
  }
