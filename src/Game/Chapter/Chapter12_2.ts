class Chapter12_2 extends egret.DisplayObjectContainer {
  ...
  private initView () {
    ...
    let cha12_2_01_options = {
      pic: "ch12_2_01_jpg",
      tips_pic: "",
      music: "ch10_3_01_mp3",
      animationType: ""
    }
    this.cha12_2_01 = new Comic2(cha12_2_01_options);
    this.mainContent.addChild(this.cha12_2_01);
  }
  ...
  private onClickView () {
    ...
    switch (this.picIndex) {
      case 1: 
        SceneController.GameEnd("end_branch_06");
        break;
    }
    this.picIndex ++;
  }
